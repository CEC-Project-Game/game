...
namespace NotEnoughBlendshape
{
    public class BlendshapeTransfer : MonoBehaviour
    {
        ...
        {
            Mesh sourceMesh = sourceModel.transform.Find("Face").GetComponent<SkinnedMeshRenderer>().sharedMesh;
            Mesh targetMesh = targetModel.transform.Find("Face").GetComponent<SkinnedMeshRenderer>().sharedMesh;
